...
//--- indicator buffers mapping
   ...
   SetIndexBuffer(0,ExtBarBuffer);
   SetIndexBuffer(1,ExtMacdBuffer);
   SetIndexBuffer(2,ExtSignalBuffer);

//--- name for DataWindow and indicator subwindow label
   IndicatorShortName("MACD2("+IntegerToString(InpFastEMA)+","+IntegerToString(InpSlowEMA)+","+IntegerToString(InpSignalSMA)+")");
   ...
   for(i=0; i<limit; i++)
     {
      ...
      // ExtBarBuffer[i] = ExtMacdBuffer[i]-ExtSignalBuffer[i];
     }
